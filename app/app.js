  ...
  $rootScope.login = function (a, b) {
    ...
    if (a == "" || b == "") {
      ...
      console.log("user data-------", data);
            ...
            console.log("WE Should get the data here",data);
            $rootScope.authMsg = data.message.toString();
          });
    }
  };
  $rootScope.modeView = true;
  $rootScope.onAdmin = function() {
    localStorage.setItem('adminMode', true);
    $rootScope.modeView = false;
  }
  $rootScope.onOperation = function() {
    ...
    return {
        ...
        controller: function($scope) {
          ...
          $scope.rotate = function () {
            rotate += 90;
            $scope.rotateStyle = { 'transform': 'rotate(' + rotate + 'deg)' };
          }
        },
...
angular.module('BlurAdmin').constant("MY_CONSTANT", {
  ...
  // "url":"http://34.202.160.90:6500", // live
  "url":"http://18.211.241.237:6500",
