    ...
    function appointmentsDriverCtrl($timeout, $scope, $http, MY_CONSTANT,ngDialog,$state,$filter,$rootScope,calendarConfig,moment) {
        ...
        $scope.get_driver = function() {
            ...
            .success(function (data,status) {
                ...
                var i= $scope.pendingDrivers.count;
                $scope.limitOptions = [10, 25, 35, i];
                // console.log("llllllllll", d);
                ...
                if($scope.query.requestType === 0) {
                    ...
                    // console.log("verifieddata-----", $scope.verifiedDrivers.data);
        ...
        function downloadCSV(csv, filename) {
          ...
          $scope.exportTableToCSV = function(filename) {
              console.log("iuhjhkjhkjh",filename);
            var csv = [];
