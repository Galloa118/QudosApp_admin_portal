...
(function () {
    ...
    function driverDetailsCtrl($timeout, $scope, $http, MY_CONSTANT,ngDialog,$state,$filter,$rootScope,$stateParams) {
        ...
        function getVehicleDetails(){
            // console.log("url--------------", MY_CONSTANT.url);
            ...
            .success(function(data) {
                ...
                // console.log('car details loaded successful-----------.',data);
                ...
                $scope.car_info.vin_number = data.data.vin_number;
            })
            .error(function (data) {
        ...
        $scope.editDetails = function(editFor){
            ...
            console.log('$scope.edit[editFor]',$scope.edit[editFor],$scope.driver.first_name);
            if(editFor=='driver'){
                $.post(MY_CONSTANT.url + '/admin/edit_new_driver', {
                    ...
                    .success(function(data) {
                        console.log('Edit successfuljjjjjj.',data);
        ...
        $scope.get_all_docs = function() {
            ...
            .success(function (data,status) {
                ...
                console.log("pta ni kese chalega",data);
        ...
        if(!localStorage.getItem('driverData')) {
          $state.go('drivers.appointments');
            ...
            console.log('driverid_driverid', $scope.driver_email, $scope.driver_email);
        ...
        // $scope.removeDoc = function (docID, docflag) {
        //     localStorage.setItem('driverID', $scope.resId);
        //     ngDialog.open({
        //         template: 'remove_Doc_modalDialog',
        //         className: 'ngdialog-theme-default',
        //         showClose: false,
        //         scope: $scope
        //     });
        ...
        $scope.verify_driver_doc = function(doc_id) {
            ...
            var dialog = ngDialog.open({
                template: 'verify_Doc_modalDialog'
            });
