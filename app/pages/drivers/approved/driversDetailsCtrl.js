...
(function () {
    ...
    angular.module('BlurAdmin.pages.drivers.driversDetails')
        .controller('driversDetailsCtrl', driversDetailsCtrl);
    function driversDetailsCtrl($timeout, $scope, $http, MY_CONSTANT,ngDialog,$state,$filter,$rootScope,$stateParams) {
        ...
        $scope.carTypes = [{name:'QS (4 max)',type:1},
            ...
            console.log("CARRRRRRRRRRRRRRRRRRRRRRRRRRRRRTYPEEEEEEEE",);
        ...
        function getVehicleDetails(){
            $.post(MY_CONSTANT.url + '/admin/get_approved_vehicle_details', {
        ...
        $scope.editDetails = function(editFor){
            ...
            // console.log('STATE',$scope.driver.email);
            if(editFor=='driver'){
                
                $.post(MY_CONSTANT.url + '/admin/edit_approved_driver', {
                    access_token: localStorage.getItem('access_token'),
                    driver_id: $scope.driver.driver_id,
                    // driver_name: $scope.driver.driver_name,
                    driver_name: $scope.driver.driver_name,
                    driver_email: $scope.driver.driver_email,
                    driver_mobile: $scope.driver.driver_mobile,
                    ...
                    referral_code: $scope.driver.referral_code,
                    date_registered: $scope.driver.date_registered
                })
                    .success(function(data) {
                ...
                $.post(MY_CONSTANT.url + '/admin/edit_approved_vehicle_details', {
                    access_token: localStorage.getItem('access_token'),
                    driver_id: $scope.driver.driver_id,
        ...
        $scope.get_all_car_types = function() {
            ...
            .success(function (data,status) {
            //  console.log("vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv",data);
        ...
        $scope.get_all_docs = function() {
            ...
            .success(function (data,status) {
                ...
                $scope.driver.docs = [];
               $scope.driver.driver_name=$scope.docs[0].driver_name;
               $scope.driver.driver_email=$scope.docs[0].driver_email;
               $scope.driver.driver_mobile=$scope.docs[0].driver_mobile;
               $scope.driver.referral_code=$scope.docs[0].referral_code;
                $scope.driver.zipcode=$scope.docs[0].zipcode;
                $scope.driver.annual_income=$scope.docs[0].annual_income;
                $scope.driver.tlc_num=$scope.docs[0].tlc_num;
                $scope.driver.uber_rating=$scope.docs[0].uber_rating;
                $scope.driver.lyftUser=$scope.docs[0].lyftUser;
                $scope.driver.lyft_rating=$scope.docs[0].lyft_rating;
                $scope.driver.uberUser=$scope.docs[0].uberUser;
                $scope.driver.dmv_num=$scope.docs[0].dmv_num;
        ...
        if(!localStorage.getItem('driverData')) {
          ...
          $state.go('drivers.appointments');
            ...
            $scope.driver_email = $scope.driver.driver_email;
        ...
        $scope.addNewDocType = function(newDoc, newDoc_type_id, doc_type) {
            ...
            .success(function(data, status) {
                ...
                if (data.flag == 1303) {
                    ...
                    $scope.get_all_docs();
                    // $state.reload();
                    $state.go('drivers.driversDetails');
                }
                if (data.flag == 1302) {
                    $scope.submitText='Submit';
        ...
        $scope.nextapi=function() {
            ...
            .success(function(data, status) {
                ...
                // console.log('get_all_docsget_all_docs--------------', $scope.docTypes);
                $scope.docLength = data.docs.length;
        ...
        $scope.redirect_driver_tab = function() {
