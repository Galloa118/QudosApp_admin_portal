...
(function() {
  ...
  angular
    .module("BlurAdmin.pages.reportdetails.pastridesreport")
    .controller("pastridesreportCtrl", pastridesreportCtrl);

  function pastridesreportCtrl(
    $timeout,
    $scope,
    $http,
    MY_CONSTANT,
    ...
    $scope.getPage = function() {
      ...
      $http
        ...
        .success(function(data, status) {
          console.log("Past Rides ",data);
          $scope.isLoading = false;
          // console.log('pastridesreportCtrl', data);
