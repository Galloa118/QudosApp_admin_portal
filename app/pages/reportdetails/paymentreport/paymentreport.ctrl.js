...
(function () {
    ...
    angular.module('BlurAdmin.pages.reportdetails.paymentreport')
        .controller('paymentreportCtrl', paymentreportCtrl);

    function paymentreportCtrl($timeout, $scope, $http, MY_CONSTANT,ngDialog,$state,$filter,$rootScope,$mdSidenav,$log) {
       // console.log('paymentreportCtrlpaymentreportCtrlpaymentreportCtrl', MY_CONSTANT.url+ '/user_list');
        ...
        $scope.getPage = function () {
            ...
            $http.post(MY_CONSTANT.url + '/admin/get_rides_by_type', {
