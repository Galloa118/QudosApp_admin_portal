...
function resizeMe(img) {
  ...
  $scope.dataURItoBlob = function(dataURI) {
    ...
    $scope.saveFareDetails = function(fareDetails) {
      ...
      form.append('fare_per_km',parseFloat(fareDetails.fare_per_km));
      form.append('fare_per_min',parseFloat(fareDetails.fare_per_min));
      form.append('fare_fixed',parseFloat(fareDetails.fare_fixed));
      form.append('black_car_fund',parseFloat(fareDetails.black_car_fund));
      form.append('sales_tax',parseFloat(fareDetails.sales_tax));
      form.append('minimum_fare',parseFloat(fareDetails.minimum_fare));
      form.append('cancellation_fee',parseFloat(fareDetails.cancellation_fee));
