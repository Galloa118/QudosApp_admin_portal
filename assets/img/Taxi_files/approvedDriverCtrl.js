...
(function () {
    ...
    function approvedDriverCtrl($timeout, $scope, $http, MY_CONSTANT,ngDialog,$state,$filter,$rootScope) {
        'use strict';
        var bookmark;
...
//==============================================================================================================================
        ...
        $scope.getApprovedDriversList = function () {
            ...
            $.post(MY_CONSTANT.url + '/driver_list', {
                ...
                .success(function (data,status) {
                    ...
                    $scope.list=d.paginated_drivers;
     ...
     * --------- funtion to view driver's rides ---------------------------------------
     --------------------------------------------------------------------------*/
      ...
      $scope.editDriver = function (d) {
        localStorage.setItem('driverID',d.driver_id);
